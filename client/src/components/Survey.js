  ...
  render() {
    return (
      <>
        ...
        <div
          className={this.state.active ? "survey-form active" : "survey-form"}
        >
          <div>
            ...
            <form className="survey-form-items" onSubmit={this.sendDataToDb}>
              <div className="survey-category">
                ...
                <div className="survey-button-container">
                  ...
                  >
                    <button
                      className="survey-buttons-front"
              ...
              >
                <span className="survey-submit-front">Submit</span>
              </button>
            </form>
            <br />
          </div>
